...
4. 使用中文输出
5. 仅输出改写后的查询文本，不要任何解释、引号或前缀

# 示例
输入：
对话历史：
user: Z-Brain 支持哪些文档格式？
assistant: Z-Brain 支持 PDF、Word、PPT、Excel 等格式。
最新问题：那解析速度怎么样？
输出：
Z-Brain 文档解析速度怎么样

# 输入
对话历史（每行格式为 role: content）：
{history}
...
5. **中文回答**：请使用中文回答，无论已知信息是什么语言。
6. **简洁专业**：回答应简洁明了，避免不必要的重复和废话。
...
VALUES (
    ...
    'dashscope',
    'text-embedding-v4',
    'sk-ws-H.RYHDILP.oVEN.MEUCIQDv-Gf1NRBKQKkslPej-CvpLHQIgQo7tH-VvR9DdoC3zYA3XnXrG5tMHB9sUnjCloROo-UA',
...
VALUES (
    ...
    'dashscope',
    'qwen3-rerank',
    'sk-ws-H.RYHDILP.oVEN.MEUWNGLFJ34-Gf1NRBKQKkslPej-CvpLHQIgQo7tH-VvR9DdoC3zYA3XnXrG5tMHB9sUnjCloROo-UA',
    'https://dashscope.aliyuncs.com/api/v1',
    TRUE,
    TRUE,
    0
...
VALUES (
    ...
    'openai_compatible',
    'mimo-v2.5-pro',
    'tp-cty0u6ahqoq0goj3mdimqmyqae7kauupilw2g',
...
SELECT 'llama_index',
       TRUE,
       'llx-mEpMFEoBrnhwZow0q1heiEGBcFHxdL2qkHSuUXQAk',

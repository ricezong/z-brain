 ...
 *
 * <p>配置由数据库 {@code sys_api_config} 表管理（configType = llama_index），通过 {@link SysApiConfigService} 读取。
...
public class LlamaIndexParser {
    ...
    private final SysApiConfigService configService;
    private final DocumentParser documentParser;
    private final ObjectMapper objectMapper;

    public LlamaIndexParser(SysApiConfigService configService, DocumentParser documentParser,
    ...
    public boolean isEnabled() {
        return configService.isEnabled(CONFIG_TYPE);
    }
    ...
    public String parse(byte[] fileBytes, String filename) {
        ...
        SysApiConfig config = configService.getConfig(CONFIG_TYPE);

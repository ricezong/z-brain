 ...
 *
 * <p>将 Tika {@code ToHTMLContentHandler} 输出的 HTML 按标签语义主动改写为
 ...
 *   <li>其他内联标签（{@code <b>/<i>/<a>}）保留纯文本内容</li>
 * </ul>
 *
 * <p>PDF 特殊处理：</p>
 * <ul>
...
public final class HtmlToMarkdownConverter {
    ...
    /**
     * 检测文本是否为编号标题，返回 Markdown 标题层级（1-6），非标题返回 0。
     *
     * <p>编号深度与标题层级映射：</p>
     * <ul>
     ...
     *
     * @param text 待检测文本
     * @return Markdown 标题层级（1-6），非标题返回 0
     */

...
public class ThreadPoolConfig {
    ...
    public Executor parseExecutor() {
        ...
        executor.setThreadNamePrefix("eon-parse-");
        // 队列满时由调用线程执行，避免任务丢失
    ...
    public Executor embeddingExecutor() {
        ...
        executor.setKeepAliveSeconds(60);
        executor.setThreadNamePrefix("eon-embed-");
        executor.setRejectedExecutionHandler(new ThreadPoolExecutor.CallerRunsPolicy());
        executor.setWaitForTasksToCompleteOnShutdown(true);
    ...
    public Executor retrievalExecutor() {
        ...
        executor.setQueueCapacity(200);
        executor.setKeepAliveSeconds(60);
        executor.setThreadNamePrefix("eon-retrieval-");
        executor.setRejectedExecutionHandler(new ThreadPoolExecutor.CallerRunsPolicy());
        executor.setWaitForTasksToCompleteOnShutdown(true);
    ...
    public Executor sseStreamExecutor() {
        ...
        executor.setKeepAliveSeconds(60);
        executor.setThreadNamePrefix("eon-sse-stream-");
        executor.setRejectedExecutionHandler(new ThreadPoolExecutor.CallerRunsPolicy());
        executor.setWaitForTasksToCompleteOnShutdown(true);
    ...
    public Executor asyncExecutor() {
        ...
        executor.setThreadNamePrefix("eon-async-");
